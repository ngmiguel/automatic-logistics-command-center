...
function ExecutiveSedan({ color }: { color: string }) {
  return (
    <group>
      ...
      <mesh position={[0, 0.15, 1.6]} rotation={[0.3, 0, 0]}>
  ...
  return (
    <group>
      ...
      <mesh position={[0, 0.6, 2.05]}>
        ...
        <meshStandardMaterial color="#34d399" emissive="#059669" emissiveIntensity={0.3} />
      </mesh>
    </group>
  );
}
